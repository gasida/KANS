...
kubectl apply -f https://raw.githubusercontent.com/gasida/KANS/main/5/calico-kans-vxlan.yaml >/dev/null 2>&1
...
PS1='$(kube_ps1)'$PS1
EOT
kubectl config rename-context "kubernetes-admin@kubernetes" "Service-DNS-k8s" >/dev/null 2>&1
