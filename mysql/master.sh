...
kubectl apply -f https://raw.githubusercontent.com/gasida/book-k8s-network/main/3/kube-flannel-v0.17.0.yml >/dev/null 2>&1
...
apt install kubetail etcd-client mariadb-client -y -qq >/dev/null 2>&1
